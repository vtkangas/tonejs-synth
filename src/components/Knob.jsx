...
export default function Knob({
  ...
  return (
      <div className="relative">
        ...
        <div
          className={`absolute left-1/2 transform -translate-x-1/2 text-black bg-sky-200 px-2  border-4 border-solid border-black rounded-md font-bold transition-all duration-300 ${
            isHovered
        ...
        <KnobHeadless
            ...
            onTouchEnd={handleTouchEnd} // Mobile touch"
            valueMin={valueMin}
            valueMax={valueMax}
            valueRaw={valueRaw}
